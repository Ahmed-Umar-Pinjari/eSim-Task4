...
{   
    ...
    tar xvf "$src_dir/nghdl/$ghdl.tar.gz"
...
{   
    ...
    tar -xvf nghdl/$verilator.tar.xz
...
function installNGHDL
{
    ...
    cd $src_dir
    tar -xJf $src_dir/nghdl/$nghdl-source.tar.xz -C $HOME
...
{
    # Make it executable
    sudo chmod 755 $src_dir/nghdl/src/ngspice_ghdl.py
    ...
    sudo ln -sf $src_dir/nghdl/src/ngspice_ghdl.py nghdl
