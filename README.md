...
- [Screenshoot](<screenshoots/Screenshot 1 — Ubuntu version.png>)
- [Screenshoot](<screenshoots/Screenshot 2 — VERSION_ID.png>)
- [Screenshoot](<screenshoots/Screenshot 3 — Original eSim error.png>)
- [Screenshoot](<screenshoots/Screenshot 4 — Original install-eSim.sh.png>)
...
- [Screenshot](<screenshoots/Screenshot 9 - Issue 2 libcanberra error.png>)
- [Screenshot](<screenshoots/Screenshot 10 - 25.04 canberra dependency before fix.png>)
- [Screenshot](<screenshoots/Screenshot 11 - 25.04 script backup.png>)
- [Screenshot](<screenshoots/Screenshot 12 - 25.04 canberra dependency fixed.png>)
- [Screenshot](<screenshoots/Screenshot 13 - 25.04 after fix backup.png>)
- [Screenshot](<screenshoots/Screenshot 15 - libcanberra package verification.png>)
...
* [Screenshot](<screenshoots/Screenshot 16 - Issue 2 fixed and GHDL tar error.png>)
* [Screenshot](<screenshoots/Screenshot 17 - GHDL archive check.png>)
* [Screenshot](<screenshoots/Screenshot 18 - GHDL archive missing.png>)
* [Screenshot](<screenshoots/Screenshot 19 - GHDL archive present but wrong path.png>)
* [Screenshot](<screenshoots/Screenshot 20 - GHDL install function before fix.png>)
* [Screenshot](<screenshoots/Screenshot 21 - GHDL before-fix backup.png>)
* [Screenshot](<screenshoots/Screenshot 22 - GHDL archive path fixed.png>)
* [Screenshot](<screenshoots/Screenshot 23 - GHDL after-fix backup.png>)
...
* [Screenshot](<screenshoots/Screenshot 24 - LLVM and Clang versions.png>)
* [Screenshot](<screenshoots/Screenshot 25 - GHDL configure source proof.png>)
* [Screenshot](<screenshoots/Screenshot 27 - LLVM 18 availability.png>)
* [Screenshot](<screenshoots/Screenshot 28 - LLVM 18 installation.png>)
* [Screenshot](<screenshoots/Screenshot 29 - LLVM 18 version check.png>)
* [Screenshot](<screenshoots/Screenshot 30 - LLVM 18 paths and versions.png>)
* [Screenshot](<screenshoots/Screenshot 31 - GHDL source location and LLVM18.png>)
* [Screenshot](<screenshoots/Screenshot 32 - GHDL configure with LLVM18 successful.png>)
* [Screenshot](<screenshoots/Screenshot 33 - GHDL LLVM18 build successful.png>)
* [Screenshot](<screenshoots/Screenshot 34 - GHDL LLVM18 installation verification.png>)
...
* [Screenshoot](<screenshoots/Screenshot 37 - Verilator archive missing error.png>)
* [Screenshot](<screenshoots/Screenshot 38 - Verilator archive check.png>)
* [Screenshot](<screenshoots/Screenshot 39 - Verilator install function.png>)
* [Screenshot](<screenshoots/Screenshot 40 - Verilator script backup.png>)
* [Screenshot](<screenshoots/Screenshot 41 - Verilator path fix.png>)
* [Screenshot](<screenshoots/Screenshot 42 - Verilator path and archive check.png>)
* [Screenshot](<screenshoots/Screenshot 43 - Verilator fixed installation NGHDL error.png>)
* [Screenshot](<screenshoots/Screenshot_53_Verilator_Installation_Success.png>)
...
* [Screenshot](<screenshoots/Screenshot 43 - Verilator fixed installation NGHDL error.png>)
* [Screenshot](<screenshoots/Screenshot 44 - NGHDL script backup.png>)
* [Screenshot](<screenshoots/Screenshot 45 - NGHDL install path function.png>)
* [Screenshot](<screenshoots/Screenshot 46 — NGHDL path fix.png>)
* [Screenshot](<screenshoots/Screenshot 47 — NGHDL installed, post-install path error.png>)
* [Screenshot](<screenshoots/Screenshot 50 — NGHDL Fixed Installation Success.png>)
* [Screenshot](<screenshoots/Screenshot_52_NGHDL_Installation_Success.png>)
...
* [Screenshot](<screenshoots/Screenshot 48 — NGSpice Path Fix Verified.png>)
* [Screenshot](<screenshoots/Screenshot 49 — NGSpice Path Fix Applied.png>)
* [Screenshot](<screenshoots/Screenshot 51 — NGHDL Ngspice Verification.png>)
...
* [Screenshot](<screenshoots/Screenshot_54_Final_Verification.png>)
* [Screenshot](<screenshoots/Screenshot_55_Final_eSim_Tool_Verification.png>)
* [Log](logsissue3-nghdl-fixed-installation-v2.txt)
